 ...
 */
class IntrospectionProcessor implements \EcomailDeps\Monolog\Processor\ProcessorInterface
{
    private $level;
     ...
     */
    public function __construct($level = \EcomailDeps\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
        $this->level = \EcomailDeps\Monolog\Logger::toMonologLevel($level);
