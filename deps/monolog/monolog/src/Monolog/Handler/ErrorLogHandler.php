 ...
 */
class ErrorLogHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(int $messageType = self::OPERATING_SYSTEM, $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true, bool $expandNewlines = \false)
    {
    ...
    {
        return new \EcomailDeps\Monolog\Formatter\LineFormatter('[%datetime%] %channel%.%level_name%: %message% %context% %extra%');
    }
    /**
     * {@inheritdoc}
     */
