 ...
 */
class ChannelLevelActivationStrategy implements \EcomailDeps\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var int
     */
    ...
    {
        $this->defaultActionLevel = \EcomailDeps\Monolog\Logger::toMonologLevel($defaultActionLevel);
