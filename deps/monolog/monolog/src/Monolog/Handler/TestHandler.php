 ...
 */
class TestHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\EcomailDeps\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
    ...
    {
        $level = \EcomailDeps\Monolog\Logger::toMonologLevel($level);
