 ...
 */
class PsrHandler extends \EcomailDeps\Monolog\Handler\AbstractHandler implements \EcomailDeps\Monolog\Handler\FormattableHandlerInterface
{
    /**
     ...
     */
    public function __construct(\EcomailDeps\Psr\Log\LoggerInterface $logger, $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
