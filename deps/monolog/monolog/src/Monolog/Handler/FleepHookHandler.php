 ...
 */
class FleepHookHandler extends \EcomailDeps\Monolog\Handler\SocketHandler
{
    ...
    public function __construct(string $token, $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
        if (!\extension_loaded('openssl')) {
            throw new \EcomailDeps\Monolog\Handler\MissingExtensionException('The OpenSSL PHP extension is required to use the FleepHookHandler');
        }
        $this->token = $token;
    ...
    {
        return new \EcomailDeps\Monolog\Formatter\LineFormatter(null, null, \true, \true);
    }
    /**
