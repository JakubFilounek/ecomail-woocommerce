 ...
 */
abstract class AbstractSyslogHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
    protected $facility;
    /**
     * Translates Monolog log levels to syslog log priorities.
     */
    protected $logLevels = [\EcomailDeps\Monolog\Logger::DEBUG => \LOG_DEBUG, \EcomailDeps\Monolog\Logger::INFO => \LOG_INFO, \EcomailDeps\Monolog\Logger::NOTICE => \LOG_NOTICE, \EcomailDeps\Monolog\Logger::WARNING => \LOG_WARNING, \EcomailDeps\Monolog\Logger::ERROR => \LOG_ERR, \EcomailDeps\Monolog\Logger::CRITICAL => \LOG_CRIT, \EcomailDeps\Monolog\Logger::ALERT => \LOG_ALERT, \EcomailDeps\Monolog\Logger::EMERGENCY => \LOG_EMERG];
    /**
     ...
     */
    public function __construct($facility = \LOG_USER, $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    {
        return new \EcomailDeps\Monolog\Formatter\LineFormatter('%channel%.%level_name%: %message% %context% %extra%');
    }
}
