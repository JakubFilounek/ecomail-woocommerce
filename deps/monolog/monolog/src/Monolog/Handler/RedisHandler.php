 ...
 */
class RedisHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
    private $redisClient;
    private $redisKey;
    protected $capSize;
     ...
     */
    public function __construct($redis, string $key, $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
        if (!($redis instanceof \EcomailDeps\Predis\Client || $redis instanceof \Redis)) {
