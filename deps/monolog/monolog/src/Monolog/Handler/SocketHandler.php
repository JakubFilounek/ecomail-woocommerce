 ...
 */
class SocketHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(string $connectionString, $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
