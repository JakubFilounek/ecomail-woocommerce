 ...
 */
class OverflowHandler extends \EcomailDeps\Monolog\Handler\AbstractHandler implements \EcomailDeps\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\EcomailDeps\Monolog\Logger::DEBUG => 0, \EcomailDeps\Monolog\Logger::INFO => 0, \EcomailDeps\Monolog\Logger::NOTICE => 0, \EcomailDeps\Monolog\Logger::WARNING => 0, \EcomailDeps\Monolog\Logger::ERROR => 0, \EcomailDeps\Monolog\Logger::CRITICAL => 0, \EcomailDeps\Monolog\Logger::ALERT => 0, \EcomailDeps\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     * @param bool             $bubble
     */
    public function __construct(\EcomailDeps\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
