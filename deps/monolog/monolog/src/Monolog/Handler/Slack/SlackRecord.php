 ...
 */
namespace EcomailDeps\Monolog\Handler\Slack;
...
class SlackRecord
{
    ...
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), \EcomailDeps\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \EcomailDeps\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (\true) {
            case $level >= \EcomailDeps\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \EcomailDeps\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \EcomailDeps\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \EcomailDeps\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \EcomailDeps\Monolog\Utils::DEFAULT_JSON_FLAGS) : \EcomailDeps\Monolog\Utils::jsonEncode($normalized, \EcomailDeps\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\EcomailDeps\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
