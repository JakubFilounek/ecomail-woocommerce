 ...
 */
class RotatingFileHandler extends \EcomailDeps\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \EcomailDeps\Monolog\Utils::canonicalizePath($filename);
