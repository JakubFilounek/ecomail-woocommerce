 ...
 */
class CouchDBHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
    private $options;
    public function __construct(array $options = [], $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
