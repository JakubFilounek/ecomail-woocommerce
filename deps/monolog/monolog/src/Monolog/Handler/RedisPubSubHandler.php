 ...
 */
class RedisPubSubHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
    private $redisClient;
    private $channelKey;
    /**
     ...
     */
    public function __construct($redis, string $key, $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
