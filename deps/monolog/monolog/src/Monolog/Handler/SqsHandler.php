...
use EcomailDeps\Aws\Sqs\SqsClient;
 ...
 */
class SqsHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
    ...
    /** @var string */
    private $queueUrl;
    public function __construct(\EcomailDeps\Aws\Sqs\SqsClient $sqsClient, string $queueUrl, $level = \EcomailDeps\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    protected function write(array $record) : void
    {
        ...
        if (\strlen($messageBody) >= static::MAX_MESSAGE_SIZE) {
            $messageBody = \EcomailDeps\Monolog\Utils::substr($messageBody, 0, static::HEAD_MESSAGE_SIZE);
        }
