...
use EcomailDeps\Monolog\Formatter\WildfireFormatter;
 ...
 */
class FirePHPHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \EcomailDeps\Monolog\Formatter\WildfireFormatter();
    }
    /**
