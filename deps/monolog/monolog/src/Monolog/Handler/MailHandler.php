...
use EcomailDeps\Monolog\Formatter\HtmlFormatter;
/**
 * Base class for all mail handlers
 *
 * @author Gyula Sallai
 */
abstract class MailHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return new \EcomailDeps\Monolog\Formatter\HtmlFormatter();
    }
}
