...
class Registry
{
     ...
     */
    public static function addLogger(\EcomailDeps\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \EcomailDeps\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \EcomailDeps\Monolog\Logger
    {
