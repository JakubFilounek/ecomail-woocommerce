...
namespace EcomailDeps\Invoker\Reflection;
    ...
    public static function create($callable) : \ReflectionFunctionAbstract
    {
        ...
        if (\is_array($callable)) {
            ...
            if (!\method_exists($class, $method)) {
                throw \EcomailDeps\Invoker\Exception\NotCallableException::fromInvalidCallable($callable);
            }
        ...
        throw new \EcomailDeps\Invoker\Exception\NotCallableException(\sprintf('%s is not a callable', \is_string($callable) ? $callable : 'Instance of ' . \get_class($callable)));
    }
}
