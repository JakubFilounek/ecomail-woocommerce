...
use EcomailDeps\DI\Definition\ExtendsPreviousDefinition;
/**
 * Manages a chain of other definition sources.
 *
 * @author Matthieu Napoli <matthieu@mnapoli.fr>
 */
class SourceChain implements \EcomailDeps\DI\Definition\Source\DefinitionSource, \EcomailDeps\DI\Definition\Source\MutableDefinitionSource
{
    /**
    ...
    public function getDefinition(string $name, int $startIndex = 0)
    {
        ...
        for ($i = $startIndex; $i < $count; ++$i) {
            ...
            if ($definition) {
                if ($definition instanceof \EcomailDeps\DI\Definition\ExtendsPreviousDefinition) {
    ...
    private function resolveExtendedDefinition(\EcomailDeps\DI\Definition\ExtendsPreviousDefinition $definition, int $currentIndex)
    {
    ...
    public function setMutableDefinitionSource(\EcomailDeps\DI\Definition\Source\MutableDefinitionSource $mutableSource)
    {
