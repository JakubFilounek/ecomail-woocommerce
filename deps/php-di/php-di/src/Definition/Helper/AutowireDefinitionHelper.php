 ...
 */
class AutowireDefinitionHelper extends \EcomailDeps\DI\Definition\Helper\CreateDefinitionHelper
{
    const DEFINITION_CLASS = \EcomailDeps\DI\Definition\AutowireDefinition::class;
    /**
