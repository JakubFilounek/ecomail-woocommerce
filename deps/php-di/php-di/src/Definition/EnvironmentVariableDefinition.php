 ...
 */
class EnvironmentVariableDefinition implements \EcomailDeps\DI\Definition\Definition
{
    /**
     * Entry name.
     * @var string
    ...
    public function __toString()
    {
        ...
        if ($this->isOptional) {
            if ($this->defaultValue instanceof \EcomailDeps\DI\Definition\Definition) {
