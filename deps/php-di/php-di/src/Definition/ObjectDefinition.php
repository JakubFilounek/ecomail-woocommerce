...
use EcomailDeps\DI\Definition\Dumper\ObjectDefinitionDumper;
 ...
 */
class ObjectDefinition implements \EcomailDeps\DI\Definition\Definition
{
    /**
    ...
    public function setConstructorInjection(\EcomailDeps\DI\Definition\ObjectDefinition\MethodInjection $constructorInjection)
    {
        $this->constructorInjection = $constructorInjection;
    }
    public function completeConstructorInjection(\EcomailDeps\DI\Definition\ObjectDefinition\MethodInjection $injection)
    {
    ...
    public function addPropertyInjection(\EcomailDeps\DI\Definition\ObjectDefinition\PropertyInjection $propertyInjection)
    {
    ...
    public function addMethodInjection(\EcomailDeps\DI\Definition\ObjectDefinition\MethodInjection $methodInjection)
    {
    ...
    public function completeFirstMethodInjection(\EcomailDeps\DI\Definition\ObjectDefinition\MethodInjection $injection)
    {
    ...
    {
        \array_walk($this->propertyInjections, function (\EcomailDeps\DI\Definition\ObjectDefinition\PropertyInjection $propertyInjection) use($replacer) {
        ...
        \array_walk($this->methodInjections, function ($injectionArray) use($replacer) {
            \array_walk($injectionArray, function (\EcomailDeps\DI\Definition\ObjectDefinition\MethodInjection $methodInjection) use($replacer) {
    ...
    public function replaceWildcards(array $replacements)
    {
        ...
        foreach ($replacements as $replacement) {
            $pos = \strpos($className, \EcomailDeps\DI\Definition\Source\DefinitionArray::WILDCARD);
            if ($pos !== \false) {
    ...
    {
        return (new \EcomailDeps\DI\Definition\Dumper\ObjectDefinitionDumper())->dump($this);
    }
