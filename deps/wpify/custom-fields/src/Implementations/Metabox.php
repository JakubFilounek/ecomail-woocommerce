 ...
 */
final class Metabox extends \EcomailDeps\WpifyCustomFields\Implementations\AbstractPostImplementation
{
    /** @var string */
    private $id;
    /** @var string */
    ...
    public function __construct(array $args, \EcomailDeps\WpifyCustomFields\WpifyCustomFields $wcf)
    {
        ...
        $args = wp_parse_args($args, array('id' => null, 'title' => null, 'screen' => null, 'context' => 'advanced', 'priority' => 'default', 'callback_args' => null, 'items' => array(), 'post_types' => array(), 'post_id' => null));
        $this->id = $args['id'];
    ...
    public function save($post_id)
    {
        ...
        if (\defined('EcomailDeps\\DOING_AUTOSAVE') && DOING_AUTOSAVE) {
            return $post_id;
        }
