...
final class GutenbergBlock extends \EcomailDeps\WpifyCustomFields\Implementations\AbstractImplementation
{
    private $name;
    private $title;
    private $category;
    ...
    public function __construct(array $args, \EcomailDeps\WpifyCustomFields\WpifyCustomFields $wcf)
    {
        ...
        $defaults = array(
            ...
            'keywords' => array(),
            // array
            'textdomain' => 'wpify-custom-fields',
            // string
            'styles' => array(),
            // array
            'supports' => null,
            ...
            'example' => null,
            // array
            'render_callback' => array($this, 'render_default'),
            // callable
            'uses_context' => array(),
            // array
    ...
    public function get_args($exclude = array())
    {
        ...
        $args['api'] = array('url' => $this->api->get_rest_url(), 'nonce' => $this->api->get_rest_nonce());
        return $args;
    }
    /**
     * @return string|null
    ...
    public function get_attributes()
    {
        ...
        foreach ($items as $item) {
            $attributes[$item['id']] = array('type' => $this->get_item_type($item), 'default' => $item['default']);
        }
        return $attributes;
    }
    /**
