...
{
    /** @var string[] */
    private $sanitizers = array('group' => 'sanitize_group_value', 'text' => 'sanitize_text_field', 'email' => 'sanitize_email', 'color' => 'sanitize_hex_color', 'textarea' => 'sanitize_textarea_field', 'tel' => 'sanitize_text_field', 'date' => 'sanitize_text_field', 'datetime' => 'sanitize_text_field', 'month' => 'sanitize_text_field', 'number' => 'sanitize_number_value', 'password' => 'sanitize_text_field', 'time' => 'sanitize_text_field', 'url' => 'esc_url_raw', 'week' => 'sanitize_text_field');
    /**
