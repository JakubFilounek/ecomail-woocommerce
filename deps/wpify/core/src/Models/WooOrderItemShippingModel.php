...
use EcomailDeps\Wpify\Core\Abstracts\AbstractWooOrderItemModel;
/**
 * @package Wpify\Core
 * @property WC_Order_Item_Shipping $wc_order_item
 */
class WooOrderItemShippingModel extends \EcomailDeps\Wpify\Core\Abstracts\AbstractWooOrderItemModel
{
    private $method_id;
    private $instance_id;
