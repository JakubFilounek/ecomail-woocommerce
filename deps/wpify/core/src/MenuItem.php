...
class MenuItem extends \EcomailDeps\Wpify\Core\Abstracts\AbstractComponent
{
    /**
     * @var Menu
     */
    ...
    public function is_external()
    {
        ...
        return \EcomailDeps\Wpify\Core\URLHelper::is_external($this->url);
    }
    /**
     * @return mixed
     */
    ...
    {
        if (\is_object($this->menu_object) && \is_a($this->menu_object, 'EcomailDeps\\WP_Post')) {
            if ($key) {
     ...
     * @return Menu
     */
    public function get_menu() : \EcomailDeps\Wpify\Core\Menu
    {
        return $this->menu;
    }
    /**
