...
class Menu extends \EcomailDeps\Wpify\Core\Abstracts\AbstractComponent
{
    /**
    ...
    protected function get_menu_id_from_locations($slug, $locations)
    {
        ...
        if (isset($locations[$slug])) {
            ...
            if (\function_exists('EcomailDeps\\wpml_object_id_filter')) {
    ...
    {
        return $this->plugin->create_component(\EcomailDeps\Wpify\Core\MenuItem::class, ['data' => $item, 'menu' => $this]);
    }
    /**
     * @param array $menu
     *
