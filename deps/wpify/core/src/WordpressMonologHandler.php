...
use EcomailDeps\Monolog\Handler\AbstractProcessingHandler;
/**
 ...
 */
class WordpressMonologHandler extends \EcomailDeps\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     * @param bool     $bubble
     */
    public function __construct($wpdb = null, $table, $additionalFields = array(), $level = \EcomailDeps\Monolog\Logger::DEBUG, $bubble = \true)
    {
        if (!\is_null($wpdb)) {
            $this->wpdb = $wpdb;
        }
