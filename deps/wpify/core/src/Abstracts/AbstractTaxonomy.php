...
use EcomailDeps\Wpify\Core\Interfaces\TaxonomyInterface;
use EcomailDeps\Wpify\Core\Traits\CustomFieldsTrait;
/**
 * @package Wpify\Core
 */
abstract class AbstractTaxonomy extends \EcomailDeps\Wpify\Core\Abstracts\AbstractComponent implements \EcomailDeps\Wpify\Core\Interfaces\TaxonomyInterface
{
    ...
    /** @var array */
    private $args = array();
    protected $fields_autoload = [];
    protected $fields_autosave = [];
