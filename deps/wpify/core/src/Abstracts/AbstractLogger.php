...
use EcomailDeps\Wpify\Core\WordpressMonologHandler;
abstract class AbstractLogger extends \EcomailDeps\Wpify\Core\Abstracts\AbstractComponent
{
    /**
    ...
    {
        $this->logger = new \EcomailDeps\Monolog\Logger($this->channel());
