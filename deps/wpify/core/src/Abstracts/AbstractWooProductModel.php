 ...
 * @package Wpify\Core
 */
abstract class AbstractWooProductModel extends \EcomailDeps\Wpify\Core\Abstracts\AbstractPostTypeModel implements \EcomailDeps\Wpify\Core\Interfaces\PostTypeModelInterface
{
    /**
     * @var \WC_Product
     */
