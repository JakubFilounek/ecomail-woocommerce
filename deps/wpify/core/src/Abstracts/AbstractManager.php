 ...
 */
abstract class AbstractManager extends \EcomailDeps\Wpify\Core\Abstracts\AbstractComponent
{
    /**
     */
        ...
        if (!$module) {
            ...
            foreach ($module_keys as $module_key) {
                ...
                if (\preg_match('/[a-z]/', $module_key_converted)) {
                    $module_key_converted = \preg_replace('/[A-Z]/', 'EcomailDeps\\_', \lcfirst($module_key_converted));
                }
