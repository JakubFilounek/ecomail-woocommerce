...
use Closure;
use EcomailDeps\SuperClosure\Analyzer\ClosureAnalyzer;
/**
 * @deprecated We'll remove this class
 */
class Analyzer extends \EcomailDeps\SuperClosure\Analyzer\ClosureAnalyzer
{
    /**
    ...
    {
        $reflection = new \EcomailDeps\Opis\Closure\ReflectionClosure($closure);
